...
?>
    ...
    <div class="container">
      ...
      <div class="row">
      <?php foreach($medicos as $key => $medicos):?>
        <div class="col-lg-4 text-center">
        <img class="img-circle" src="<?php echo $medico->imagem?>" alt="<?php echo$medico->nome?>" width="240" height="240">
          <h2><?php echo$medico->nome?></h2>
          <p><?php echo$medico->CRM?></p>
          <p><a class="btn btn-default" href="<?php yii\helpers\Url::toRouter(['medicos/view', 'id'=> $medico->Medicp_id]);?>" role="button">View details »</a></p>
        </div><!-- /.col-lg-4 -->
        <?php endforeach; ?>
